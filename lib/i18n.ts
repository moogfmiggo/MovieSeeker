...
export const th = {
  ...
  genreSearch: {
    ...
    mainGenres: "แนวหนัง (หัวข้อหลัก)",
    moreTopics: "แนวย่อยและธีมของหนัง",
    ...
    seriesGenres: "แนวซีรีส์ (ตัวเลือกเพิ่มเติม)",
    seriesOptInHint: "ถ้าไม่เลือกหัวข้อนี้ ระบบจะไม่แนะนำซีรีส์",
