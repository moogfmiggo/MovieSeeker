...
export const th = {
  ...
  genreSearch: {
    title: "วันนี้อยากดูอะไร?",
    subtitle: "พิมพ์เป็นประโยคเดียวแล้วค้นหาได้ทันที ระบบจะแยกประเภท ประเทศ แนว และธีมที่เข้าใจให้เอง",
    movieGenreSearchTitle: "บอกหนังที่อยากดู",
    movieGenreSearchHint: "เช่น หนังสารคดีเกี่ยวกับสงคราม หรือหนังญี่ปุ่นแนวสืบสวน",
    movieGenreSearchPlaceholder: "เช่น หนังสารคดีสงครามที่ดูได้บนสตรีมมิ่ง...",
    seriesGenreSearchTitle: "บอกซีรีส์ที่อยากดู",
    seriesGenreSearchHint: "เช่น ซีรี่เกาหลีโรแมนติกคอมเมดี้ที่ตอนจบไม่เศร้า",
    seriesGenreSearchPlaceholder: "เช่น ซีรี่เกาหลีโรแมนติกคอมเมดี้...",
    selectedMovieFilters: "แนวหนังและธีมที่เลือก",
    selectedSeriesFilters: "แนวซีรีส์ที่เลือก",
    typeToSearch: "พิมพ์คำเพื่อดูตัวเลือก โดยรายการแนวทั้งหมดจะไม่แสดงค้างบนหน้าเว็บ",
    noSearchResults: "ไม่พบแนวที่ตรงกับคำค้น",
    movieGenreTag: "แนวหนัง",
    movieTopicTag: "ธีมหนัง",
    seriesGenreTag: "แนวซีรีส์",
    seriesTopicTag: "ธีมซีรีส์",
    removeSelection: (name: string) => `นำ ${name} ออกจากตัวเลือก`,
    streamingProviders: "เลือกตามบริการสตรีมมิ่ง",
    optionalStreamingProviders: "เลือกบริการสตรีมมิ่งเพิ่มเติม (ไม่บังคับ)",
    streamingProvidersHint: "เลือกหลายบริการได้ ผลลัพธ์จะอยู่ในอย่างน้อยหนึ่งบริการที่เลือกและรับชมได้ในไทย",
    noneSelected: "ยังไม่ได้เลือกแนว ธีม หรือบริการสตรีมมิ่ง",
    selectedCount: (count: number) => `เลือกแล้ว ${count} หัวข้อ`,
    resultCount: (count: number) => `พบ ${count} ตัวเลือก`,
    selectAtLeastOne: "เลือกอย่างน้อย 1 หัวข้อเพื่อค้นหา",
    selectSeriesGenre: "เลือกอย่างน้อย 1 แนวซีรีส์เพื่อค้นหา",
    searchMovies: "ค้นหาหนัง",
    searchSeries: "ค้นหาซีรีส์",
    interpreting: "กำลังทำความเข้าใจ...",
    oneStepHint: "กดค้นหาได้เลย ไม่ต้องเลือก Genre เพิ่ม",
  },
  titleSearch: {
    title: "ค้นหาจากชื่อเรื่อง",
    compactPlaceholder: "ค้นหาจากชื่อเรื่อง...",
    subtitle: "ค้นหาหนังเป็นค่าเริ่มต้น หรือเลือกซีรีส์เมื่อต้องการค้นหาโดยเฉพาะ",
    inputLabel: "ชื่อหนังหรือซีรีส์",
    placeholder: "เช่น Dune, หลานม่า, Stranger Things",
    typeLabel: "เลือกประเภทที่ต้องการค้นหา",
    movies: "หนัง",
    series: "ซีรีส์",
    submit: "ค้นหา",
    movieResults: (query: string) => `ผลการค้นหาหนัง “${query}”`,
    seriesResults: (query: string) => `ผลการค้นหาซีรีส์ “${query}”`,
    resultCount: (count: number) => `พบ ${count.toLocaleString("th-TH")} รายการ`,
    emptyPrompt: "พิมพ์ชื่อเรื่องเพื่อเริ่มค้นหา",
    noResults: "ไม่พบชื่อเรื่องที่ค้นหา ลองตรวจการสะกดหรือใช้ชื่อภาษาอังกฤษ",
  },
  moviesPage: {
    title: "หนังยอดนิยม",
    ...
    movieResultsTitle: "ผลการค้นหาหนัง",
    seriesResultsTitle: "ซีรีส์ที่ตรงกับแนวที่เลือก",
    seriesResultsSubtitle: (count: number) => `แสดงเฉพาะซีรีส์ที่ตรงครบทั้ง ${count} แนวที่เลือก`,
  ...
  moviesError: {
    ...
    body: "เกิดข้อผิดพลาดขณะดึงข้อมูลหนังหรือซีรีส์จาก TMDB กรุณาลองใหม่อีกครั้ง",
  },
  movieList: {
    ...
    allWatched: "คุณดูรายการทั้งหมดในส่วนนี้แล้ว",
    showWatchedToo: "แสดงรายการที่ดูแล้ว",
  ...
  watchedPage: {
    ...
    subtitle: "หนังและซีรีส์ที่คุณทำเครื่องหมายว่าดูแล้ว",
    empty: "ยังไม่มีหนังหรือซีรีส์ที่ดูแล้ว",
    browseMovies: "ค้นหาหนังและซีรีส์",
    loadError: "ไม่สามารถโหลดรายการที่ดูแล้วได้ในขณะนี้ กรุณาลองใหม่อีกครั้ง",
  },
  favoritesPage: {
    title: "รายการโปรด",
    subtitle: "หนังและซีรีส์ที่คุณทำเครื่องหมายว่าชอบ",
    empty: "ยังไม่มีหนังหรือซีรีส์ในรายการโปรด",
    browseMovies: "ค้นหาหนังและซีรีส์",
  ...
  seriesDetail: {
    seasons: (count: number) => `${count} ซีซัน`,
    episodes: (count: number) => `${count} ตอน`,
    cast: "นักแสดง",
    overview: "เรื่องย่อ",
  },
  seriesDetailError: {
    title: "ไม่สามารถโหลดซีรีส์เรื่องนี้ได้",
    body: "เกิดข้อผิดพลาดขณะดึงข้อมูลซีรีส์ กรุณาลองใหม่อีกครั้ง",
  },
  movieDetailError: {
