...
export const th = {
  ...
  genreSearch: {
    ...
    subtitle: "สลับระหว่างหนังกับซีรีส์ แล้วค้นหาแนวหรือธีมที่อยากดู เลือกหลายแนวเพื่อค้นหาเรื่องที่ตรงครบทุกแนว",
    movieGenreSearchTitle: "ค้นหาแนวหนังและธีม",
    movieGenreSearchHint: "พิมพ์คำ เช่น สงคราม สารคดี ซอมบี้ หรือ time travel",
    movieGenreSearchPlaceholder: "ค้นหาแนวหนังหรือธีม...",
    seriesGenreSearchTitle: "ค้นหาแนวซีรีส์",
    seriesGenreSearchHint: "ค้นหาได้ทั้งแนว ธีม และคำใกล้เคียง ซีรีส์จะแสดงเมื่อเลือกจากช่องนี้",
    seriesGenreSearchPlaceholder: "ค้นหาแนวหรือธีมซีรีส์...",
