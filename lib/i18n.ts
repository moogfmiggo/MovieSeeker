...
export const th = {
  ...
  genreSearch: {
    ...
    subtitle: "หนังเป็นหัวข้อหลัก เลือกบริการสตรีมมิ่งได้ และซีรีส์จะปรากฏเมื่อคุณเลือกแนวซีรีส์เท่านั้น",
    ...
    seriesGenreSearchHint: "ซีรีส์จะแสดงเมื่อเลือกแนวจากช่องนี้เท่านั้น",
    seriesGenreSearchPlaceholder: "ค้นหาแนวซีรีส์...",
