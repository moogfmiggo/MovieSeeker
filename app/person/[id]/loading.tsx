  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
      <div className="flex flex-col gap-6 sm:flex-row">
        <div className="aspect-[2/3] w-40 flex-shrink-0 animate-pulse rounded-lg bg-surface sm:w-48" />
        <div className="flex flex-1 flex-col gap-2 pt-2">
          <div className="h-8 w-1/2 animate-pulse rounded bg-surface" />
          <div className="h-4 w-1/3 animate-pulse rounded bg-surface" />
          <div className="mt-2 h-16 w-full max-w-2xl animate-pulse rounded bg-surface" />
        </div>
      </div>
